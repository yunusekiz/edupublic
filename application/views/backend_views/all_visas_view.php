					...
					<form action="{base}backend/ourTeam/operation" method="post">
						...
						<table>
							...
							<tbody>
								...
								<tr>
									<td>
										<a href="{backend_base}visa/updateItemDetailForm/{visa_id}" title="Düzenle"><img src="{base}assets/backend_assets/images/icons/pencil.png" alt="Düzenle" /></a>
									</td>
									
									<td>
										<a href="{backend_base}visa/deleteItem/{visa_id}" title="Sil"><img src="{base}assets/backend_assets/images/icons/cross.png" alt="Sil" /></a>
									</td>

									<td>
										<a href="{backend_base}visa/changeItemPhotoForm/{visa_id}/{visa_photo_id}" title="Fotoğraf Yükle"><img src="{base}assets/backend_assets/images/icons/up_2.png" alt="Fotoğraf Yükle" /></a>
									</td>
