  ...
  <header class="masthead visible-desktop">
    <nav class="links desktop-nav">
      ...
      <a class="align-left" title="about" href="#services">VİZELER</a>
      <a id="logo" href="#"><img alt="eleg by designova" title="eleg" src="images/logo.png"/></a>
      <a class="align-right" title="services" href="#features">BİLDİRİMLER</a>
      <a class="align-right" title="features" href="#about">EKİBİMİZ</a>
...
<!--      <section class="container-fluid about-inner">
      <div class="row-fluid">
        <section class="container">
          ...
          {feedbacks_parser_data}
          <div class="row add-top add-bottom">
            <article class="span3 image center-mobile">
              <img alt="edupublic by edupublic" title="edupublic" src="{base}{fb_big_photo}"/>
            </article>
            <article class="span9 col-white center-mobile">
              ...
              <h4>{fb_student_name} {fb_student_surname}<span>{fb_lang_school}, {fb_country}</span></h4>
              </div>
            </article>
          </div>
          {/feedbacks_parser_data}
      ...
      <div class="row-fluid">
        <section class="container">
          ...
          <div class="row add-top-half add-bottom">
            ...
            <a href="{facebook}"><img alt="edupublic" title="facebook" src="images/social/a01.png"/></a>
            <a href="{twitter}"><img alt="edupublic" title="twitter" src="images/social/a02.png"/></a>
            <a href="{gplus}"><img alt="edupublic" title="google plus" src="images/social/a03.png"/></a>
            <a href="{linkedin}"><img alt="edupublic" title="linkedin" src="images/social/a04.png"/></a>
            <a href="{pinterest}"><img alt="edupublic" title="pinterest" src="images/social/a05.png"/></a>
            </article>
          </div>
        </section>
      </div>
